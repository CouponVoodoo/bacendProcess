...
$fullJSON='';
$sql ="select distinct brand  from scrapedproductsjabong[nolock] where retailerid IN (5,8,14785,14786)";
$response = sqlsrv_query($conn,$sql);
