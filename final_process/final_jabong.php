...
//sleep(100);
require_once('C:\xampp\htdocs\cpnVodo\SimulationWithoutAutomatn - copy\createPredictorCompiledResultTable.php');
...
if( $maxNidInDb === false ) {echo 'error Step7';
...
exec("php.exe createPredictorTargetTable.php");
...
$sql="Update dbo.cachedCouponFinderResults Set header = replace(header, '?src=search','')";
$maxNidInDb = sqlsrv_query($conn,$sql);
...
$sqlToCheckNID = "exec('update coupon_finder.1Variables set Status = 1 where Serial=4') at MYSQL";
